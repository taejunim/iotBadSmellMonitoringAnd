...
class MultiImageAdapter internal constructor(list: ArrayList<Uri>, context: Context?) : RecyclerView.Adapter<MultiImageAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = inflater.inflate(R.layout.adapter_multi_image_item, parent, false) // 리사이클러뷰에 들어갈 아이템뷰의 레이아웃을 inflate.
